    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('based_quantity', models.CharField(choices=[('عدد', 'Each'), ('جعبه', 'Box'), ('کیلوگرم', 'Kg'), ('گرم', 'Gr'), ('تن', 'Tn')], default='عدد', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(default=datetime.datetime(2021, 10, 13, 12, 39, 42, 646961))),
                ('branch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.prisonbranch')),
                ('expert', models.ManyToManyField(null=True, related_name='expert', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', django_jalali.db.models.jDateTimeField(default=datetime.datetime(2021, 10, 13, 12, 39, 42, 646961))),
                ('price', models.BigIntegerField(default=0)),
