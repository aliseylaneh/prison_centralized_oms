...
var FixedColumns = function ( dt, init ) {
	...
	this.dom = {
		...
		"grid": {
			 ...
			 * component in the display grid (making up the account table - i.e.
...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	 ...
	 * tables and get the index position for the data in the account table.
	...
	"_fnConstruct": function ( oInit )
	{
		 ...
		 * another redraw of the account table. It doesn't need to be a full redraw however.
		 */
		this._fnGridLayout();
...
/**
 * Event fired whenever FixedColumns redraws the fixed columns (i.e. clones the table elements from the account DataTable). This will occur whenever the DataTable that the FixedColumns instance is attached does its own draw.
