...
(function ($) {
  ...
  var $navbar_variants_colors = createSkinBlock(navbar_all_colors, function (e) {
    ...
    var $main_header = $('.account-header')
  ...
  var $navbar_border = $('<input />', {
    type   : 'checkbox',
    value  : 1,
    checked: $('.account-header').hasClass('border-bottom'),
    'class': 'mr-1'
  }).on('click', function () {
    if ($(this).is(':checked')) {
      $('.account-header').addClass('border-bottom')
    } else {
      $('.account-header').removeClass('border-bottom')
    }
  })
