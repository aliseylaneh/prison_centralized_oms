...
function CrepServerCallOut() {
    ...
    group = document.getElementById('selected-group').value
    ...
    if (group !== '0') {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#loadingBar").hide()
                data.expert_reports.forEach(item => {
                    requestTable.innerHTML += `
                    <tr>
                        <td class="text-center">${item.user_name}</td>
                        <td class="text-center">${item.username}</td>
                        <td class="text-center">${item.user_categories}</td>
                        <td class="text-center">${item.request_count}</td>
                        <td class="text-center">${item.request_acc_count}</td>
                        <td class="text-center">${item.request_returned_count}</td>
                        <td class="text-center">${item.request_declined_count}</td>
                    </tr>
                `
                })
